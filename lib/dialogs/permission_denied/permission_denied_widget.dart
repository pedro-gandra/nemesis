...
import 'permission_denied_model.dart';
export 'permission_denied_model.dart';
...
class _PermissionDeniedWidgetState extends State<PermissionDeniedWidget> {
  late PermissionDeniedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PermissionDeniedModel());
  }
